...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="dashoboard.css">
    <title>NexusPro </title>
        ...
        <div class="container-fluid">
          <nav class="navbar navbar-expand-lg custom_nav-container ">
            <a class="navbar-brand" href="index.html">
              <span>
              <p>Welcome to NexusPro , <?php echo $data['name']; ?>!</p>
              </span>
            </a>
        ...
        <div class="row">
          <div class="col-md-6 ">
            <div class="detail-box">
              ...
              <p>
              Our comprehensive range of services caters to every aspect of maintaining and enhancing your home environment. We specialize in professional cleaning services, including deep cleaning, regular maintenance, and specialized treatments for carpets, upholstery, and more. Our repair services cover a wide spectrum, from plumbing and electrical work to appliance repairs and structural fixes. 
              </p>
              <a href="">
                Contact Us
              </a>
          ...
          <div class="col-md-6">
            <div class="img-box">
              ...
              <img src="./images/homeservice.svg"> </img>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-5 col-md-6">
          <div class="detail-box">
            ...
            <p>
            Our journey began with a vision to revolutionize home services, guided by integrity, reliability, and innovation. Our exceptional team of professionals undergoes rigorous training and background checks to ensure high standards of professionalism. We prioritize quality assurance through eco-friendly products, sustainable practices, and continuous feedback mechanisms. Our mission is to exceed expectations, enhance living spaces, and simplify the lives of our clients.
            </p>
            <a href="">
              Read More
            </a>
      ...
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="detail-box">
            ...
            <p>
            Our service categories are designed to meet the diverse needs of our customers, including Home Cleaning, Repairs, Beauty & Wellness, and more. Each service is meticulously described to provide clarity on what it entails, its benefits, and any unique features. For example, our Home Cleaning service involves deep cleaning of all areas, using eco-friendly products for a healthier environment. 
            </p>
            <a href="">
              Read More
            </a>
        ...
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
              We offer proactive maintenance plans tailored to your needs, keeping your home systems in optimal condition year-round.
              </p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
              Our skilled technicians handle electrical installations, repairs, and upgrades to ensure your home's safety and efficiency.
              </p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
              From leak repairs to pipe installations, our plumbing experts deliver reliable solutions for a smoothly functioning plumbing system.
              </p>
            </div>
          </div>
        </div>
